...
Because Sealmetrics operates under legitimate interest and processes minimal data, it can retain analytics data for 25 months without consent—longer than Google Analytics' 14-month maximum under consent-free operation.
...
| Data Retention (no consent) | 14 months | **25 months** |
| **Data Accuracy** | | |
